...
Mean number of total steps per day: `r vMean`  
Median number of total steps per day: `r vMedian`  
...
The 5 minute interval labeled `r vMaxStepInterval` contains the max number of average daily steps across all 5-minute intervals, `r vMaxSteps`.  
...
Count of NA step values: `r vNACount`  
...
Mean numbrer of total steps per day (no missing values): `r vMean2`  
Median number of total steps per day (no missing values): `r vMedian2`  

Mean number of total steps per day(with missing values): `r vMean`  
Median number of total steps per day (with missing values): `r vMedian`
